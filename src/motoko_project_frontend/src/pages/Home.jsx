...
const Home = () => {
	...
	const handlegetAuctions = async () => {
		setIsLoading(true);
		motoko_project_backend.getAuctions().then((auctions) => {
	...
	const handleCheckBalance = async () => {
		setIsLoading(true);
		const balance = await motoko_project_backend.getMyBalance();
	...
	const handleFundWallet = async () => {
		...
		if (amount) {
			setIsLoading(true);
			await motoko_project_backend.newUser(Number(amount));
